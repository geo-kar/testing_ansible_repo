...
##STAM##added to jboss WS.xml configuration file (removed from WS.xml, since according to HPS is not needed for WS)
#JAVA_OPTS="$JAVA_OPTS -DPWCCFGVAR=/srv/pwrcard/WS/cfg"
